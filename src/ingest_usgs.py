...
DEFAULT_URL = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_hour.geojson"
...
def main(url: str = DEFAULT_URL):
    ...
    print(f"Fetched {len(features)} features from {data.get('metadata', {}).get('url', url)}")
